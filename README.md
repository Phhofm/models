...
12.01.2025 - [2xBHI_small_compact_pretrain](https://github.com/Phhofm/models/releases/tag/2xBHI_small_compact_pretrain) (2x compact bicubic only model, goal was to reach high metrics on psnry)   
